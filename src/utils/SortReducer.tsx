...
const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case SortAction.LAST_NAME:
      return {
        ...state,
        users: state.users.sort((a, b) => a.name.last.localeCompare(b.name.last)),
      };

    case SortAction.AGE:
      return {
        ...state,
        users: state.users.sort((a, b) => a.dob.age - b.dob.age),
      };

    case SortAction.NAT:
      return {
        ...state,
        users: state.users.sort((a, b) => a.nat.localeCompare(b.nat)),
      };
